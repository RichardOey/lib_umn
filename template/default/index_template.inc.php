...
<!-- ==================== Added by Richard Firdaus O. ======================== -->
<link href="<?php echo $sysconf['template']['dir']; ?>/default/css/custom_style.css" rel="stylesheet" type="text/css" />
<!-- bxSlider CSS file -->
<link href="<?php echo $sysconf['template']['dir']; ?>/default/css/jquery.bxslider.css" rel="stylesheet" />
<!-- ==================== End of added by Richard Firdaus O. ======================== -->
...
<div class="content">
  <div class="container">
    ...
    <!--Fitur rekomendasi buku (Added by Richard Firdaus O.-->
    <?php include('custom_recommendation_book.php'); ?>
  </div>
...
<!-- ==================== Added by Richard Firdaus O. ======================== -->
<script src="<?php echo $sysconf['template']['dir']; ?>/default/js/jquery.bxslider.min.js"></script>
<script>
  var rec_item_count = $('.rec-slider-li').length;

  if(rec_item_count < 5){
    $('.bxslider').bxSlider({
    minSlides: rec_item_count,
    maxSlides: 4,
    slideWidth: 180,
    slideMargin: 1,
